    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-md border border-gray-100">
        <div className="text-center mb-8">
          <h1 className="text-2xl md:text-3xl font-bold text-dark mb-2">用户登录</h1>
          <p className="text-muted">登录你的账户继续学习</p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-muted">
            没有账户？ <a href="/register" className="font-medium text-primary hover:text-blue-700">立即注册</a>
          </p>
        </div>
